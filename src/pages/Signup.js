        ...
        return (
            <div className="signup">
                <form className="form" onSubmit={this.handleSubmit}>
                    ...
                    <button className="btn form-btn mb-sm" type="submit">Sign up</button>
                    <p className="form-text">Already have an account? <Link className="form-link" to="/login">Log In</Link></p>
                </form>
            </div>
        )
    }
